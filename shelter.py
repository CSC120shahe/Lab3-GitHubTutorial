...
if dog_percap > 100:
    print(
        f'DOG MAX={str(num_dogs)}: CRISIS SITUATION - shelter at %{dog_percap:.2f} of dog capacity')
else:
    print(
        f'DOG MAX={str(num_dogs)}: Shelter at %{dog_percap:.2f} of dog capacity')

cat_percap = num_cats/CAT_CAP * 100
if cat_percap > 100:
    print(
        f'CAT MAX={str(num_cats)}: CRISIS SITUATION - shelter at %{cat_percap:.2f} of cat capacity')
else:
    print(
        f'CAT MAX={str(num_cats)}: Shelter at %{cat_percap:.2f} of cat capacity')
